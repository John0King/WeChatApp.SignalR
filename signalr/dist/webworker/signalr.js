...
/* harmony import */ var _ITransport__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(19);
...
/* harmony import */ var _JsonHubProtocol__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(21);
...
/* harmony import */ var _Errors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _HttpClient__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
/* harmony import */ var _WeChatHttpClient__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
...
var DefaultHttpClient = /** @class */ (function (_super) {
    ...
    function DefaultHttpClient(logger) {
        ...
        _this.httpClient = new _WeChatHttpClient__WEBPACK_IMPORTED_MODULE_2__["WeChatHttpClient"](logger);
        return _this;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WeChatHttpClient", function() { return WeChatHttpClient; });
/* harmony import */ var _Errors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _HttpClient__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
        ...
        return new Promise(function (resolve, reject) {
            var xhr = wx.request({
                ...
                fail: function (response) {
                    _this.logger.log(_ILogger__WEBPACK_IMPORTED_MODULE_2__["LogLevel"].Warning, "Error from HTTP request. " + response.errMsg + ".");
                    reject(new _Errors__WEBPACK_IMPORTED_MODULE_0__["HttpError"](response.errMsg, 500)); // no status code
                },
                success: function (response) {
                    ...
                    if (response.statusCode >= 200 && response.statusCode < 300) {
                        ...
                        resolve(new _HttpClient__WEBPACK_IMPORTED_MODULE_1__["HttpResponse"](response.statusCode, _this.mapStatusCode(response.statusCode), content));
                    }
                    else {
                        reject(new _Errors__WEBPACK_IMPORTED_MODULE_0__["HttpError"](response.errMsg, response.statusCode));
                    }
                }
            });
            if (request.abortSignal) {
...
/* harmony import */ var _DefaultReconnectPolicy__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17);
/* harmony import */ var _HttpConnection__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(18);
/* harmony import */ var _HubConnection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9);
/* harmony import */ var _ILogger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8);
/* harmony import */ var _JsonHubProtocol__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(21);
/* harmony import */ var _Loggers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(13);
...
/* harmony import */ var _ITransport__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(19);
/* harmony import */ var _Utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12);
/* harmony import */ var _WeChatWebSocketTransport__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(20);
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
...
if (_Utils__WEBPACK_IMPORTED_MODULE_3__["Platform"].isNode && "function" !== "undefined") {
...
var HttpConnection = /** @class */ (function () {
    function HttpConnection(url, options) {
        ...
        if (!_Utils__WEBPACK_IMPORTED_MODULE_3__["Platform"].isNode && typeof wx.connectSocket !== "undefined" && !options.WebSocket) {
            // options.WebSocket = WebSocket; // no need this
        }
        else if (_Utils__WEBPACK_IMPORTED_MODULE_3__["Platform"].isNode && !options.WebSocket) {
            // if (WebSocketModule) {
    ...
    HttpConnection.prototype.constructTransport = function (transport) {
        switch (transport) {
            case _ITransport__WEBPACK_IMPORTED_MODULE_2__["HttpTransportType"].WebSockets:
                ...
                return new _WeChatWebSocketTransport__WEBPACK_IMPORTED_MODULE_4__["WeChatWebSocketTransport"](this.httpClient, this.accessTokenFactory, this.logger, this.options.logMessageContent || false);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WeChatWebSocketTransport", function() { return WeChatWebSocketTransport; });
/* harmony import */ var _ILogger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8);
/* harmony import */ var _ITransport__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(19);
